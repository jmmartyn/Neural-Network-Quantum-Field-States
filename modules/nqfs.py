...
fot deep sets networks DS1 and DS2.
'''
...
class NQFS():
    ...
    def Local_Energy(self, x, m, mu, V, W):
        '''
        ...
        if torch.numel(x) > 0:
            ...
            PE_local += torch.sum(W(interparticle_distances), axis=1)[:, None]
        else:
    ...
    def Energy_Estimate(self, x_sorted, chain_idx_sorted, n_chains, GPU_device,
        ...
        Local_Energies = []
        for x in x_sorted:
            Local_Energies.append(self.Local_Energy(x, m, mu, V, W))
    ...
    def Local_Gradient_Energy(self, x, m, mu, V, W):
        '''
    ...
    def Energy_Grad_Estimate(self, x_sorted, n, chain_idx_sorted, n_chains,
        ...
        for x in x_sorted:
            ...
            E_log_Psi_grad_sum1, E_log_Psi_grad_sum2 = \
                self.Local_Gradient_Energy(x, m, mu, V,W)
    ...
    def ADAM_update(self, x_sorted, n, chain_idx_sorted, n_chains, GPU_device, m,
                    mu, V, W, t, m1, v1, m2, v2, beta_1, beta_2, lr, lr_q):
        '''
        ...
        E, E_std, E_grad1, E_grad2 = self.Energy_Grad_Estimate(x_sorted, n, \
                                                               chain_idx_sorted, n_chains, GPU_device, m, mu, V, W)
    ...
    def plot_energy(self, Es, E_stds, E_exact, start, end):
        ...
        Parameters:
          ...
          end: the last iteration at which data is plotted
        '''
